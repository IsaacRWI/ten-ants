...
def state_to_meme(arm_state, hand_state, mouth_state):
    if arm_state:
        ...
        elif arm_state == "arms_over_head" and mouth_state == "open": return "memes/monke in distress.jpg"
        ...
        elif arm_state == "arms_up" and hand_state == "open": return "memes/absolute cinema.jpg"
        ...
        elif arm_state == "business_hands" and hand_state == "thumbs_up": return "memes/trade offer.jpg"
        elif arm_state == "choking" and mouth_state == "mouth_closed": return "memes/choking.jpg"
        elif arm_state == "arms_over_head" and hand_state == "peace" and mouth_state == "open": return "memes/sigma wolf.jpg"
        elif arm_state == "pointing" and hand_state == "thumbs_up": return "memes/cat thumbs up.jpg"
        elif arm_state == "choking" and mouth_state == "mouth_open": return "memes/monke clutching pearls.jpg"
        ...
        elif arm_state == "pointing" and hand_state == "thumbs_down": return "memes/thumbs down.jpg"
        elif arm_state == "arm_to_mouth" and hand_state == "open": return "memes/rage baiting.jpg"
        elif arm_state == "arm_over_head" and mouth_state == "mouth_open": return "memes/whistle.jpg"
        ...
        elif arm_state == "business_hands" and mouth_state == "open": return "memes/squirrel eviscerated.jpg"
